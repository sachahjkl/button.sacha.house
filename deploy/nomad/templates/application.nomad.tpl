  ...
  group "web" {
    ...
    task "web" {
      ...
      service {
        ...
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.button-sacha-house-staging.entrypoints=websecure",
          "traefik.http.routers.button-sacha-house-staging.middlewares=button-sacha-house-staging-noindex",
          "traefik.http.routers.button-sacha-house-staging.rule=Host(`[[ var "domain" . ]]`)",
          "traefik.http.routers.button-sacha-house-staging.tls.domains[0].main=[[ var "domain" . ]]",
...
job "button-sacha-house" {
  ...
  group "web" {
    ...
    task "web" {
      ...
      service {
        name     = "button-sacha-house-production"
        provider = "nomad"
        port     = "http"
        tags = [
          "traefik.enable=true",
          "traefik.http.routers.button-sacha-house-production.entrypoints=websecure",
          "traefik.http.routers.button-sacha-house-production.rule=Host(`[[ var "domain" . ]]`)",
        ]
